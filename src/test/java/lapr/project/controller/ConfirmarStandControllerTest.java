...
public class ConfirmarStandControllerTest {
    ...
    public void testSetExposicao() {
        ...
        Exposicao e = new Exposicao("a", "b", new Data(2017, 06, 10), new Data(2017, 06, 11), new Data(2017, 06, 12), new Data(2017, 06, 13), new Data(2017, 06, 14), new Data(2017, 6, 15), new Data(2017, 6, 16), new Local("l"), ce);
        instance.setExposicao(e);
