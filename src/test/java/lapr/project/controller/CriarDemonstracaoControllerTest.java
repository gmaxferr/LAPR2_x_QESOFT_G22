...
public class CriarDemonstracaoControllerTest {
    ...
    public void setUp() {
        ...
        e = new Exposicao("titulo", "descricao", new Data(2015, 01, 03), new Data(2015, 01, 04), new Data(2015, 01, 05), new Data(2015, 01, 06), new Data(2015, 01, 07), new Data(2015, 5, 8), new Local("Local"), ce);
