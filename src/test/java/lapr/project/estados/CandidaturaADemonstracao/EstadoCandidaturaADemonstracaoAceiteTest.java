 ...
 * @author G29
 */
public class EstadoCandidaturaADemonstracaoAceiteTest {

    public EstadoCandidaturaADemonstracaoAceiteTest() {
    }
    ...
    private EstadoCandidaturaADemonstracao instance = new EstadoCandidaturaADemonstracaoAceite(m_cand);

    @Before
    public void setUp() {
        m_cand.setEstado(new EstadoCandidaturaADemonstracaoAceite(m_cand));
    }
     ...
     * EstadoCandidaturaADemonstracaoAceite.
     */
    @Test
     ...
     * class EstadoCandidaturaADemonstracaoAceite.
     */
    @Test
