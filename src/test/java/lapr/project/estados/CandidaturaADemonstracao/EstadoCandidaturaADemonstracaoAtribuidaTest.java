...
public class EstadoCandidaturaADemonstracaoAtribuidaTest {
    ...
    public EstadoCandidaturaADemonstracaoAtribuidaTest() {
    }
    ...
    private CandidaturaADemonstracao m_cand = new CandidaturaADemonstracao("dado", "a@b.c");
    private EstadoCandidaturaADemonstracao instance = new EstadoCandidaturaADemonstracaoAtribuida(m_cand);
     ...
     * EstadoCandidaturaADemonstracaoAtribuida.
     */
    @Test
 ...
 EstadoCandidaturaADemonstracaoAtribuida.
     ...
     * class EstadoCandidaturaADemonstracaoAtribuida.
     */
    @Test
