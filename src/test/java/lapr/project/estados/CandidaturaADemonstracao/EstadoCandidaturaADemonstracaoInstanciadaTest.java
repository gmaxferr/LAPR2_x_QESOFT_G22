 ...
 * @author G29
 */
public class EstadoCandidaturaADemonstracaoInstanciadaTest {

    public EstadoCandidaturaADemonstracaoInstanciadaTest() {
    }
    ...
    private EstadoCandidaturaADemonstracao instance = new EstadoCandidaturaADemonstracaoInstanciada(m_cand);

    @Before
    public void setUp() {
        m_cand.setEstado(new EstadoCandidaturaADemonstracaoInstanciada(m_cand));
    }
     ...
     * EstadoCandidaturaADemonstracaoInstanciada.
     */
    @Test
     ...
     * class EstadoCandidaturaADemonstracaoInstanciada.
     */
    @Test
