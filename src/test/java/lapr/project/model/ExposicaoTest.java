...
public class ExposicaoTest {
    ...
    public void setUp() {
        ...
        e = new Exposicao(titulo, desc, data1, data2, data3, data4, data5, data6, data7, local, ce);
    ...
    public void testHashCode() {
        ...
        Exposicao expo = new Exposicao(titulo, desc, data1, data2, data3, data4, data5, data6, data7, local, ce);
