...
public class RegistoExposicoesTest {
    ...
    public RegistoExposicoesTest() {
        ...
        expo2 = new Exposicao("titulo2", "desc2", data1, data1, data1, data1, data1, data1, data1,new Local("Rua das flores... :P"), ce);
        expo2.setEstado(new EstadoExposicaoCandidaturasAvaliadas(expo2));

        expo3 = new Exposicao("titulo3", "desc2", data1, data1, data1, data1, data1, data1, data1,new Local("Rua das flores... :P"), ce);
        ...
        expo4 = new Exposicao("titulo4", "desc2", data1, data1, data1, data1, data1, data1, data1,new Local("Rua das flores... :P"), ce);
        expo4.setEstado(new EstadoExposicaoCandidaturasAbertas(expo4));

        expo5 = new Exposicao("titulo5", "desc2", data1, data1, data1, data1, data1, data1, data1,new Local("Rua das flores... :P"), ce);
        expo5.getRegistoOrganizadores().addOrganizador(user1);
        expo5.setEstado(new EstadoExposicaoCriada(expo5));

        expo6 = new Exposicao("titulo6", "desc2", data1, data1, data1, data1, data1, data1, data1,new Local("Rua das flores... :P"), ce);
        expo6.getRegistoOrganizadores().addOrganizador(user2);
        expo6.setEstado(new EstadoExposicaoCriada(expo6));

        expo7 = new Exposicao("titulo7", "desc2", data1, data1, data1, data1, data1, data1, data1,new Local("Rua das flores... :P"), ce);
        expo7.getRegistoOrganizadores().addOrganizador(user2);
        expo7.setEstado(new EstadoExposicaoDemosDefinidasSemFAE(expo7));

        expo8 = new Exposicao("titulo8", "desc2", data1, data1, data1, data1, data1, data1, data1,new Local("Rua das flores... :P"), ce);
        expo8.getRegistoOrganizadores().addOrganizador(user2);
        expo8.setEstado(new EstadoExposicaoFAEDefinidosSemDemos(expo8));
        
        expo9 = new Exposicao("titulo9", "desc2", data1, data1, data1, data1, data1, data1, data1,new Local("Rua das flores... :P"), ce);
        ...
        expo10 = new Exposicao("titulo10", "desc2", data1, data1, data1, data1, data1, data1, data1,new Local("Rua das flores... :P"), ce);
        
        expo11 = new Exposicao("titulo10", "desc2", data1, data1, data1, data1, data1, data1, data1,new Local("Rua das flores... :P"), ce);
    ...
    public void testRegistaExposicao() {
        ...
        e = new Exposicao("titulo", "desc", new Data(2016, 1, 2), new Data(2018, 1, 3), new Data(2016, 1, 3), new Data(2016, 1, 4), new Data(2016, 1, 6), new Data(2016, 1, 7), new Data(2016, 1, 8), new Local("Rua das flores... :P"), ce);
        expResult = true;
